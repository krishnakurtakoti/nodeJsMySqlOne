...
thenBusboy = function(req, op) {
  ...
  return new Promise(function(resolve, reject) {
    ...
    ignoreUnallowed = mimes.ignoreUnallowed, allowed = mimes.allowed;
    if (isEmpty(allowed) === false && isPlainObject(allowed) === false) {
      throw new TypeError("The list of allowed mime-types should be a plain object.");
    }
    fields = {};
    files = {};
